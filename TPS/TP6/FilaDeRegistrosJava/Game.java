...
class Fila {
    ...
    public void mostrar() {
        ...
        for (int i = 0; i < tamanho; i++) {
            System.out.println("[" + i + "] " + array[pos].toJudgeLine());
...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            int numComandos = Integer.parseInt(sc.nextLine().trim());
            ...
            for (int i = 0; i < numComandos; i++) {
                ...
                if (comando.equals("I")) {
                    int gameId = Integer.parseInt(partes[1]);
                    Game g = byId.get(gameId);
                    if (g != null) {
                        fila.enfileirar(g);
                    }
